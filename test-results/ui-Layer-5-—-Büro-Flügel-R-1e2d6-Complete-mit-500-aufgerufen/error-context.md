...
- Name: ui.spec.js >> Layer 5 — Büro-Flügel (Routing) >> Alle 5 zugeordnet → onComplete mit 500 aufgerufen
- Location: tests/ui.spec.js:303:3
...
- generic [active] [ref=e1]:
  - generic:
    ...
    - generic: Fadenkreuz auf die blaue S1-Tafel links richten und E drücken.
  - generic:
    - generic: 75%
    - generic: ★ 0 Punkte
    - generic: ⏱ 00:00
  ...
  - generic [ref=e3]:
    - generic [ref=e4]: TCP/IP-Lagerhaus · Spielmodus
    - generic [ref=e5]: 🎮
    - generic [ref=e6]: Wie möchtest du spielen?
    - generic [ref=e7]: Wähle deinen Durchlauf. Du kannst den Modus für diese Sitzung nicht mehr ändern.
    - generic [ref=e8]:
      - button "🧭 Geführter Durchlauf Die Szenarien werden in fester Reihenfolge (S1→S5) durchlaufen. Jeder Raum ist gesperrt, bis die vorherige Aufgabe abgeschlossen ist." [ref=e9] [cursor=pointer]:
        - generic [ref=e10]: 🧭
        - generic [ref=e11]: Geführter Durchlauf
        - generic [ref=e12]: Die Szenarien werden in fester Reihenfolge (S1→S5) durchlaufen. Jeder Raum ist gesperrt, bis die vorherige Aufgabe abgeschlossen ist.
      - button "🧮 Freier Durchlauf Du bestimmst die Reihenfolge selbst. Keine Sperren — starte jedes Szenario per grünem Knopf im jeweiligen Raum." [ref=e13] [cursor=pointer]:
        - generic [ref=e14]: 🧮
        - generic [ref=e15]: Freier Durchlauf
        - generic [ref=e16]: Du bestimmst die Reihenfolge selbst. Keine Sperren — starte jedes Szenario per grünem Knopf im jeweiligen Raum.
  - generic [ref=e17]:
    - button "Enter VR mode with a headset or fullscreen without" [ref=e19] [cursor=pointer]
